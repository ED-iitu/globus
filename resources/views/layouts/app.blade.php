                    ...
                    @else
                        @if (Auth::user()->role == 1)
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('banner.index')}}">Банеры</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('facility.index')}}">Добавить заведения</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('category.index')}}">Категории заведений</a>
                                </li>
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{route("infographic.index")}}">
                                           Инфографика
                                        </a>
                        ...
                        @else
                            ...
                            <ul class="navbar-nav mr-auto">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{route('my.index')}}">Мои заведения</a>
                                </li>
                            </ul>
                        @endif
                    @endguest
