    ...
    <div class="container">
        ...
        <div class="row mb-3">
            <div class="col-lg-12 margin-tb">
                <div class="pull-left">
                    <h2>Добавление информации арендаторам</h2>
                </div>
                <div>
        ...
        <hr>
        <form action="{{route('renter.store')}}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                <input type="text" class="form-control" id="uname" placeholder="Телефон" name="phone">
            </div>
